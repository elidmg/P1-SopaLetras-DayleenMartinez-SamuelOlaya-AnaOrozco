...
public class Menu extends javax.swing.JFrame {
    ...
    private void BuscarEspecificoBottonInicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BuscarEspecificoBottonInicioActionPerformed
        ...
        // Validar que la entrada del usuario no esté vacía
        String entradaUsuario = EntradaBottonBuscar.getText().trim(); // Obtener y limpiar la entrada del JTextField
        if (entradaUsuario.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor, ingrese una palabra para buscar.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
